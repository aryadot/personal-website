    ...
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-20 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-10 text-sm font-bold uppercase tracking-[0.2em]">
          ...
          <a href="/#resume" className="text-foreground/60 hover:text-primary transition-colors">
            Resume
          </a>
          <Link href="/projects">
            <a className="text-foreground/60 hover:text-primary transition-colors">Projects</a>
          </Link>
        </nav>

        <Link href="/projects">
          <a className="hidden md:flex px-8 py-2.5 rounded-full font-bold text-sm bg-foreground text-background hover:scale-105 transition-all shadow-lg">
            Projects
          </a>
        </Link>
      </div>
