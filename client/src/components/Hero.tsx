        ...
        <div className="relative z-10">
          ...
          <FadeIn delay={0.4}>
            <p className="text-lg text-foreground/70 leading-relaxed max-w-lg">
              I build ML systems and LLM-powered applications — from RAG pipelines to predictive models — to understand how 
              real-world data systems actually work. I'm drawn to problems in finance, adtech, and healthcare where the stakes 
              are high and the data is messy.
            </p>
          </FadeIn>
